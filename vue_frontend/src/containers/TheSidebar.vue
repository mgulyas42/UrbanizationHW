<template>
  ...
  >
    <CSidebarBrand class="d-md-down-none" to="/">
      <v-img contain src="http://oktatas.mik.uni-pannon.hu/pluginfile.php/1/theme_enlightlite/logo/1604907398/cimer_szines_99_transparent.png" max-height="150pxt"></v-img>
    </CSidebarBrand>
